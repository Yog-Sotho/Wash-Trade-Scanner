...
class HeuristicDetector:
    ...
    async def detect_high_frequency_bot(
        ...
        for sender, sender_trades in sender_groups.items():
            ...
            # Optimization: Fully vectorized NumPy implementation.
            # Pre-extract attributes to avoid ORM overhead in tight loops.
            ...
            if len(volumes_array) == 0:
                ...
                # Use population std (ddof=0) to match original manual calculation.
