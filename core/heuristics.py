...
class HeuristicDetector:
    ...
    async def detect_high_frequency_bot(
        ...
        # Optimization: hoist settings lookups outside the loop
        ...
        for sender, sender_trades in sender_groups.items():
            ...
            # Fully vectorized calculation of stats using NumPy
            ...
            if volumes_array.size == 0:
                ...
                # Use population std (ddof=0) to match original variance/std logic
